...
N 1020 -80 1020 -60 {lab=#net1}
C {nooverlap_clk.sym} -30 -170 0 0 {name=x1}
C {tg_sw_2.sym} -30 -50 0 0 {name=x2}
C {dac_sw_2.sym} -30 80 0 0 {name=x3}
...
C {tg_sw_2.sym} 470 -50 0 0 {name=x4}
...
C {tg_sw_2.sym} 870 -50 0 0 {name=x5}
C {devices/lab_wire.sym} 720 -80 0 0 {name=p29 sig_type=std_logic lab=vdda}
C {devices/lab_wire.sym} 720 -20 0 0 {name=p30 sig_type=std_logic lab=vssa}
C {devices/lab_wire.sym} 720 -60 0 0 {name=p31 sig_type=std_logic lab=clk1}
C {devices/lab_wire.sym} 720 -40 0 0 {name=p32 sig_type=std_logic lab=clkb1}
C {devices/lab_wire.sym} 620 -80 0 1 {name=p33 sig_type=std_logic lab=vcm}
C {devices/lab_wire.sym} 1020 -80 0 1 {name=p34 sig_type=std_logic lab=dac_out}
